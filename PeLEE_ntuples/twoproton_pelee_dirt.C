 ...
 ////////////////////////////////////////////                                                                                
  ...
  float_t zmax = 1036.8 - FV_edge;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      // 2) The start/end point of every pfp is within the FV (i.e. contained)
      ...
      hist.h_topological_score->Fill(topological_score,pot_wgt); //need to add the mc_cv_wgt here
      hist.h_cosmic_impact_parameter->Fill(CosmicIP,pot_wgt); //need to add the mc_cv_wgt here
