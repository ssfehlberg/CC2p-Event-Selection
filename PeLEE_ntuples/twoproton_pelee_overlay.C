...
void twoproton_pelee_overlay::Loop()
{
  ...
  std::cout<<"CC2p after pid: "<<cc2p0pi[5]<<std::endl;
  std::cout<<"CC2p after containment: "<<cc2p0pi[6]<<std::endl;
  std::cout<<"CC2p after momentum: "<<cc2p0pi[7]<<std::endl;
  ...
  std::cout<<"other_nc: "<<other_nc<<std::endl;
  std::cout<<"other_QE: "<<other_QE<<std::endl;
  std::cout<<"other_RES: "<<other_RES<<std::endl;
  std::cout<<"other_DIS: "<<other_DIS<<std::endl;
  std::cout<<"other_COH: "<<other_COH<<std::endl;
  std::cout<<"other_MEC: "<<other_MEC<<std::endl;
  std::cout<<"other_nu_pdg: "<<other_nu_pdg<<std::endl;
  std::cout<<"other_anti_nu_pdg: "<<other_anti_nu_pdg<<std::endl;
  std::cout<<"other_threshold_muon: "<<other_threshold_muon<<std::endl;
