...
namespace Constants{
  ...
  double MUON_MOM_CUT_LOW = 0.1; //0
  double MUON_MOM_CUT_HIGH = 1.2;//999;
  double PROTON_MOM_CUT_LOW = 0.3;//0;
  double PROTON_MOM_CUT_HIGH = 1.0;//999;
  double CHARGED_PI_MOM_CUT = 0.065;//0.0
  double NEUTRAL_PI_MOM_CUT = 0.0;
  /*
  //uncomment this block if you are making the threshold plots
  double MUON_MOM_CUT_LOW = 0.0;
  double MUON_MOM_CUT_HIGH = 999;
  double PROTON_MOM_CUT_LOW = 0.0;                                                                                                                                                                                                                                         
  double PROTON_MOM_CUT_HIGH = 1.0;//999;                                                                                                                                                                                                                                    
  double CHARGED_PI_MOM_CUT = 0;//999;                                                                                                                                                                                                                                      
  double NEUTRAL_PI_MOM_CUT = 0.0;
  */
