...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 private:
  ...
  int other_MEC = 0;
  int other_nu_pdg = 0;
  int other_anti_nu_pdg = 0;
  int other_threshold_muon = 0;
...
twoproton_pelee_overlay::twoproton_pelee_overlay(TTree *tree) : fChain(0) 
{
  ...
  if(response =='1'){
    ...
    //file = "/uboone/data/users/apapadop/searchingfornues/high_stat_prodgenie_bnb_nu_overlay_DetVar_Run3_SCE_reco2_reco2.root";
    file = "/uboone/data/users/davidc/searchingfornues/v08_00_00_44/0724/noweights/prodgenie_bnb_nu_overlay_DetVar_SCE_reco2_v08_00_00_38_run3b_reco2_reco2.root";
  } else{
...
void twoproton_pelee_overlay::Fill_Histograms_Mine(int i, double wgt, int mc_n_threshold_muon, int mc_n_threshold_proton, int mc_n_threshold_pion0, int mc_n_threshold_pionpm, bool fv){
  ...
  //OUT OF FV                                                                                                                                
    ...
    if(i == 7){
      std::cout<<"[FILL_HISTOGRAMS_MINE] Inside of the else loop"<<std::endl;
	...
	other_anti_nu_pdg++;
      ...
      if(mc_n_threshold_muon != 0){
	other_threshold_muon++;
      }

      std::cout<<"[FILL_HISTOGRAMS_MINE] value of mc_n_threshold_muon: "<<mc_n_threshold_muon<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of mc_n_threshold_proton: "<<mc_n_threshold_proton<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of mc_n_threshold_pion0: "<<mc_n_threshold_pion0<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of mc_n_threshold_pionpm: "<<mc_n_threshold_pionpm<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of ccnc: "<<ccnc<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of nu_pdg: "<<nu_pdg<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of interaction: "<<interaction<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of mc_pdg->size(): "<<mc_pdg->size()<<std::endl;
      std::cout<<"[FILL_HISTOGRAMS_MINE] value of n_pfps "<<n_pfps<<std::endl;

      for ( size_t p = 0u; p < mc_pdg->size(); ++p ) {
	std::cout<<"Value of MC PDG at p="<<p<<" : "<<mc_pdg->at( p )<<std::endl;
      }

      for(int i = 0; i < n_pfps; i ++){
	std::cout<<"Value of track PID at i="<<i<<" : "<<trk_llr_pid_score_v->at(i)<<std::endl;
      }	
