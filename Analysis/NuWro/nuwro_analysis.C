...
void nuwro_analysis::main(){
  ...
  TFile *f_overlay_CV = new TFile(Form("../root_files/pelee/%s/histograms_pelee%s_overlay_wgt.root",run,sample));//overlay histograms.
  ...
  Grab_Histograms(f_overlay,f_overlay_CV,f_bnb,f_ext,f_dirt,f_eff,f_mom_thresholds);
  ...
  for(int i = 0; i < num_var; i++){
    ...
    //muon:mine
    Plot_Histograms(run,pot_num,sample_name,colors, h_muon_overlay_vec, h_muon_overlay_CV[i],h_muon_overlay0[i][1],h_muon_overlay0[i][2],h_muon_stat[i],h_muon_systematic[i],
    ...
    //muon:raquel
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_muon_overlay_raquel_vec, h_muon_overlay_CV[i],h_muon_overlay0_raquel[i][1],h_muon_overlay0_raquel[i][2],h_muon_stat[i],h_muon_systematic[i],
		    h_muon_ext[i][0], h_muon_ext[i][1], h_muon_ext[i][2],
		    h_muon_dirt[i][0],h_muon_dirt[i][1],h_muon_dirt[i][2],
    ...
    //leading proton:mine
    Plot_Histograms(run,pot_num,sample_name,colors, h_leading_overlay_vec,  h_leading_overlay_CV[i],h_leading_overlay0[i][1],h_leading_overlay0[i][2],h_leading_stat[i],h_leading_systematic[i],
    ...
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_leading_overlay_raquel_vec, h_leading_overlay_CV[i] ,h_leading_overlay0_raquel[i][1],h_leading_overlay0_raquel[i][2],h_leading_stat[i],h_leading_systematic[i],
		    h_leading_ext[i][0], h_leading_ext[i][1], h_leading_ext[i][2],
		    h_leading_dirt[i][0],h_leading_dirt[i][1],h_leading_dirt[i][2],
    ...
    //recoil proton:mine
    Plot_Histograms(run,pot_num,sample_name,colors, h_recoil_overlay_vec, h_recoil_overlay_CV[i], h_recoil_overlay0[i][1],h_recoil_overlay0[i][2],h_recoil_stat[i],h_recoil_systematic[i],
    ...
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_recoil_overlay_raquel_vec, h_recoil_overlay_CV[i] ,h_recoil_overlay0_raquel[i][1],h_recoil_overlay0_raquel[i][2],h_recoil_stat[i],h_recoil_systematic[i],
		    h_recoil_ext[i][0], h_recoil_ext[i][1], h_recoil_ext[i][2],
		    h_recoil_dirt[i][0],h_recoil_dirt[i][1],h_recoil_dirt[i][2],
  ...
  ////////////////////////////////
   for(int i=0; i < num_phys; i++){
    ...
    //mine 
    Plot_Histograms(run,pot_num,sample_name,colors, h_phys_overlay_vec,  h_phys_overlay_CV[i],h_phys_overlay0[i][1],h_phys_overlay0[i][2],h_phys_stat[i],h_phys_systematic[i],
    ...
    //raquel
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_phys_overlay_raquel_vec,  h_phys_overlay_CV[i], h_phys_overlay0_raquel[i][1],h_phys_overlay0_raquel[i][2],h_phys_stat[i],h_phys_systematic[i],
		    h_phys_ext[i][0], h_phys_ext[i][1], h_phys_ext[i][2],
                    h_phys_dirt[i][0],h_phys_dirt[i][1],h_phys_dirt[i][2],
  ...
  ///////////////////////////////////////////
   for(int i=0; i < num_stv; i++){
    ...
    //mine 
    Plot_Histograms(run,pot_num,sample_name,colors, h_stv_overlay_vec, h_stv_overlay_CV[i], h_stv_overlay0[i][1],h_stv_overlay0[i][2], h_stv_stat[i], h_stv_systematic[i],
    ...
    //raquel
    Plot_Histograms(run,pot_num,sample_name,colors_raquel, h_stv_overlay_raquel_vec,  h_stv_overlay_CV[i] ,h_stv_overlay0_raquel[i][1],h_stv_overlay0_raquel[i][2],h_stv_stat[i],h_stv_systematic[i],
                    h_stv_ext[i][0], h_stv_ext[i][1], h_stv_ext[i][2],
                    h_stv_dirt[i][0],h_stv_dirt[i][1],h_stv_dirt[i][2],
