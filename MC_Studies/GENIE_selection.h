...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   GENIE_selection(TTree *tree=0);
   virtual ~GENIE_selection();
...
#ifdef GENIE_selection_cxx
GENIE_selection::GENIE_selection(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
  ...
  if(response =='0'){
    ...
    file = "/uboone/data/users/sfehlber/MC_Studies/GENIE/40Ar_uBFluxGeV_CCinclMEC_GTEST19_10b_00_000_Q2_0_0.root";
    sample = "susav2";
  } else if(response == '3'){
...
Int_t GENIE_selection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GENIE_selection::LoadTree(Long64_t entry)
{
...
void GENIE_selection::Init(TTree *tree)
{
...
void GENIE_selection::Show(Long64_t entry)
{
...
Int_t GENIE_selection::Cut(Long64_t entry)
{
...
#endif // #ifdef GENIE_selection_cxx
