...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("twoproton_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("twoproton_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("twoproton_anatree.root:/TwoProtonAna");
