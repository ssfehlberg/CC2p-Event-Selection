...
void twoproton_filtered::Loop()
{
  ...
  bool short_trk;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) { //Loop over every entry in the file
	...
	std::cout<<"Good Track end at "<<i<<" : "<<good_trk_end_x.at(i)<<std::endl;
	std::cout<<"Good Track end at "<<i<<" : "<<good_trk_end_y.at(i)<<std::endl;
	std::cout<<"Good Track end at "<<i<<" : "<<good_trk_end_z.at(i)<<std::endl;
	}*/
      //}
