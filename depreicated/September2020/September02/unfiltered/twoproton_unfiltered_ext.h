...
// from TTree tree/
// found on file: /uboone/data/users/sfehlber/2020/Sep2020/Sep02/ext.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/sfehlber/2020/Sep2020/Sep02/ext.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/sfehlber/2020/Sep2020/Sep02/ext.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/sfehlber/2020/Sep2020/Sep02/ext.root:/TwoProtonAna");
...
void twoproton_unfiltered_ext::Define_Histograms(){
  ...
  for(int k=0; k < num_plane; k++){
    ...
    h_chi2mu[k] = new TH1D(Form("h_chi2mu%s_ext",plane[k]),Form("h_chi2mu%s_ext",plane[k]),50,0,120);h_dEdx_total[k] = new TH1D(Form("h_dEdx_total%s_ext",plane[k]),Form("h_dEdx_total%s_ext",plane[k]),20,0,1000);
